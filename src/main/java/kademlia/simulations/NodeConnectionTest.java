...
public class NodeConnectionTest
{
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try
        {
            ...
            //see the difference between those nodes
            System.out.println(kad1.getNode().getNodeId() + " ^ " + kad2.getNode().getNodeId() + " = "
                    + kad1.getNode().getNodeId().xor(kad2.getNode().getNodeId()));
            System.out.println("Kad 1 - Kad 2 distance: " +
                    kad1.getNode().getNodeId().xor(kad2.getNode().getNodeId()).getFirstSetBitIndex());
